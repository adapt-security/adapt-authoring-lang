...
import { storeStrings } from './utils/storeStrings.js'
import { translate as translateFn } from './utils/translate.js'
import { translateError as translateErrorFn } from './utils/translateError.js'
...
class LangModule extends AbstractModule {
  ...
  translate (lang, key, data) {
    return translateFn(this.phrases, this.getConfig('defaultLang'), msg => this.log('warn', msg), lang, key, data)
  }
  ...
  translateError (lang, error) {
    return translateErrorFn(this.phrases, this.getConfig('defaultLang'), msg => this.log('warn', msg), lang, error)
  }
}
